---
title: "Продвинутые стохастические градиентные методы. Методы редукции дисперсии. Muon"
...
* **AlgoPerf Benchmark:** Сравнивает алгоритмы обучения нейросетей по двум наборам правил:
    ...
    * **Self-Tuning:** Моделирует автоматическую настройку на одной машине (3× бюджет).
...
* **Стоимость:** Оценка потребовала $\sim 49{,}240$ часов на 8× NVIDIA V100 GPU.
